...
1. **Run `/find-projects` workflow** — first API-based project scan
2. **Update me.hiplus.de** — reposition as "Business Automation Advisor"
3. **Update LinkedIn profile** — use texts from `freelance_brainstorming/.planning/linkedin_copy_paste.md`
4. **Create first new bid** using `/new-bid` workflow
5. **Set up bid tracking** — which bids were sent, responses, won/lost
